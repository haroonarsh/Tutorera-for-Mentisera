...
to {
  ...
  animation: ${Q} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Y=({toast:e})=>{let{icon:t,type:r,iconTheme:o}=e;return void 0!==t?"string"==typeof t?s.createElement(X,null,t):t:"blank"===r?null:s.createElement(q,null,s.createElement(B,{...o}),"loading"!==r&&s.createElement(U,null,"error"===r?s.createElement(O,{...o}):s.createElement(H,{...o})))},Z=x("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
