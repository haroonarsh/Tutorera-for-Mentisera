...
to {
  ...
  animation: ${Q} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,X=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?s.createElement(K,null,t):t:"blank"===r?null:s.createElement(q,null,s.createElement(L,{...a}),"loading"!==r&&s.createElement(U,null,"error"===r?s.createElement(W,{...a}):s.createElement(H,{...a})))},Y=x("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
