...
export default function TutorProfileActions(props: Props) {
  ...
  return <>
    ...
    <button onClick={() => setBooking(true)} style={{ width: "100%", padding: ".9rem", border: 0, borderRadius: 8, background: "#0329B2", color: "white", fontWeight: 800, cursor: "pointer" }}>Book Now</button>
