...
export default function ServicesPage() {
  return <main className={s.page}>
    <section className={s.hero}><h1>TUTORERA Tutoring Services</h1><p>Tutoring rates are determined by individual tutor offers and may vary based on subject, academic level, tutor experience, teaching mode, location, session duration and student requirements. The final agreed tutoring rate is displayed in PKR before booking and payment.</p></section>
