      ...
      <section style={{ padding: '4rem 1.5rem' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          {[
            ...
            { title: "Step 2 — Get Verified", desc: "Submit identity and education documents. Requirements vary by market and teaching mode; we notify you by email when review is complete." },
            { title: "Step 3 — Browse Requests", desc: "Go to your dashboard to browse relevant open tuition requests in enabled markets and online worldwide." },
            ...
            { title: "Step 5 — Start Teaching", desc: "In checkout-enabled markets, a booking becomes active after the student accepts your offer and payment is confirmed. Discovery beta markets show availability clearly." },
          ].map(item => (
