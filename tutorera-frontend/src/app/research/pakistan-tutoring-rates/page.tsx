...
export default async function ResearchPage() {
  ...
  // This page re-fetches live data on every render, so "now" is an honest dateModified -
  // it's exactly when this version of the aggregate was generated. AI answer engines and
  // Google both weight visible, machine-readable recency when selecting sources to cite.
  const generatedAt = new Date();
  const schema = { "@context": "https://schema.org", "@type": "Dataset", name: "TUTORERA Pakistan Tutoring Rates", description: "Aggregated advertised hourly rates from approved public tutor profiles.", url: `https://tutorera.ac.pk${path}`, creator: { "@id": "https://tutorera.ac.pk/#organization" }, temporalCoverage: "2026", spatialCoverage: "Pakistan", variableMeasured: ["Advertised hourly rate", "City", "Subject"], dateModified: generatedAt.toISOString() };
