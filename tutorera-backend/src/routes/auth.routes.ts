...
import { register, login, logout, getMe, updateProfile, changePassword, googleAuth, selectRole, forgotPassword, resetPassword, exportData, deleteAccount, updateConsent } from "../controllers/auth.controller";
