export const bookingConfirmedEmail = (studentName: string, tutorName: string, amount: number) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Your booking with <strong>${tutorName}</strong> has been confirmed.</p>
      <div style="background: #eff6ff; border-radius: 8px; padding: 16px; margin: 20px 0;">
        <p style="color: #1a1a2e; margin: 0; font-weight: 700;">Amount: Rs. ${amount.toLocaleString()}</p>
      </div>
...
export const bidAcceptedEmail = (tutorName: string, studentName: string, amount: number) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Hi ${tutorName},</p>
      <p style="color: #374151;"><strong>${studentName}</strong> has accepted your bid! A booking has been created.</p>
      <div style="background: #f0fdf4; border-radius: 8px; padding: 16px; margin: 20px 0;">
        <p style="color: #1a1a2e; margin: 0; font-weight: 700;">Session Amount: Rs. ${amount.toLocaleString()}</p>
      </div>
...
export const tutorPendingEmail = (name: string) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      <h2 style="color: #1a1a2e;">Thanks for applying, ${name}!</h2>
...
export const tutorRejectedEmail = (name: string, reason?: string) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      <h2 style="color: #1a1a2e;">Update on your application, ${name}</h2>
...
export const planUpgradedEmail = (name: string, plan: string) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Hi ${name}, your TUTORERA® plan has been upgraded to <strong style="text-transform: capitalize;">${plan}</strong>.</p>
...
export const paymentConfirmedEmail = (studentName: string, tutorName: string, amount: number) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Hi ${studentName}, we've confirmed your payment of <strong>Rs. ${amount.toLocaleString()}</strong> for your session with ${tutorName}.</p>
...
export const bookingCancelledEmail = (name: string, otherPartyName: string, subject?: string) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Hi ${name}, your booking with ${otherPartyName}${subject ? ` for ${subject}` : ""} has been cancelled.</p>
...
export const newBidEmail = (studentName: string, amount: number) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Hi ${studentName}, a tutor has placed a bid of <strong>Rs. ${amount.toLocaleString()}</strong> on your tuition request.</p>
...
export const directBookingRequestEmail = (tutorName: string, studentName: string, subject: string) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Hi ${tutorName}, <strong>${studentName}</strong> wants to book a session with you for <strong>${subject}</strong>.</p>
...
export const directBookingAcceptedEmail = (
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Hi ${name}, your session with <strong>${otherPartyName}</strong> for <strong>${subject}</strong> is confirmed.</p>
      ${date && startTime ? `
      <div style="background: #eff6ff; border-radius: 8px; padding: 16px; margin: 20px 0;">
        <p style="color: #1a1a2e; margin: 0 0 6px; font-weight: 700;">📅 ${date}</p>
        <p style="color: #1a1a2e; margin: 0; font-weight: 700;">🕐 ${startTime} – ${endTime}</p>
      </div>
      ` : ""}
      ${paymentInfo ? `
      <div style="background: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; padding: 16px; margin: 20px 0;">
        ...
        <p style="color: #374151; margin: 0; font-size: 14px;">
          Please send Rs. ${paymentInfo.amount.toLocaleString()} to NayaPay ID: <strong>mentisera@nayapay</strong> and email proof to <strong>billing@tutorera.pk</strong>.
        </p>
      </div>
      ` : ""}
...
export const directBookingDeclinedEmail = (studentName: string, subject: string) => ({
  ...
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #374151;">Hi ${studentName}, the tutor was unable to accept your booking request for <strong>${subject}</strong>.</p>
